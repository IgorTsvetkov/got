    ...
    public function safeUp()
    {
        ...
        $this->batchInsert(
            ...
            [
                ...
                ["Ваш города повреждены диким огнем и требует капитального ремонта. Заплатить 40 _money_sign_ за каждый дом и 115 _money_sign_ за каждый постоялый двор","payForRepairHomeAndInn",40],
